  ...
  return (
    <div className={classes.root}>
      ...
      <Typography variant="body2" className={classes.text}>
        ...
        http://sarasotachristianfellowship.com
      </Typography>
      <br />
      ...
      <Typography variant="body2" className={classes.text}>
        sarasota uses the collected data for various purposes:
      </Typography>
      <ul>
      ...
      <br />
      <Typography variant="body2" className={classes.text}>
        sarasota will take all steps reasonably necessary to ensure that your
      ...
      <br />
      <Typography variant="body2" className={classes.text}>
        sarasota may disclose your Personal Data in the good faith belief that
        such action is necessary to:
      </Typography>
      <br />
      <ul>
        <li>To comply with a legal obligation</li>
        <li>To protect and defend the rights or property of sarasota</li>
        <li>
